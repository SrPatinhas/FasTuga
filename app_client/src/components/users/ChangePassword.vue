...
<template>
	...
	<section class="col-lg-8 pt-lg-4 pb-4 mb-3">
		<div class="pt-2 px-4 ps-lg-0 pe-xl-5">
			...
			<hr/>
			<div v-if="userStore.errors" class="alert alert-danger" v-for="(erro, index) of userStore.errors" >
				{{ erro[0] }}
			</div>
			<form class="row g-3 needs-validation" novalidate @submit.prevent="changePassword">
				...
				<div class="mb-3 col-12 col-md-6">
					<div class="mb-3">
						...
						<input type="password" class="form-control" id="inputPasswordConfirm" ref="passwordConfirmation"
							   required v-model="passwords.password_confirmation"/>
						<field-error-message :errors="userStore.errors"
											 fieldName="password_confirmation"></field-error-message>
					</div>
				</div>
