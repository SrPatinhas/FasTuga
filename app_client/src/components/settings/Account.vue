		...
		<div class="pt-2 px-4 ps-lg-0 pe-xl-5" v-if="userStore.customer">
			...
			<ul class="nav nav-tabs nav-justified" role="tablist">
				<li class="nav-item" role="presentation">
					<a class="nav-link px-0 active" href="#profile" data-bs-toggle="tab" role="tab" aria-selected="true">
						<div class="d-none d-lg-block">
							<i class="ci-user opacity-60 me-2"></i>Profile
						</div>
				...
				<li class="nav-item" role="presentation">
					<a class="nav-link px-0" href="#userInformation" data-bs-toggle="tab" role="tab" aria-selected="false" tabindex="-1">
						<div class="d-none d-lg-block"><i class="ci-bell opacity-60 me-2"></i>User information</div>
						<div class="d-lg-none text-center">
			...
			<div class="tab-content">
				...
				<!-- User information -->
				<div class="tab-pane fade" id="userInformation" role="tabpanel">
					<div class="row gx-4 gy-3">
						<div class="col-sm-6">
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<div class="row g-3 mb-2">
						<div class="col-sm-6">
							<input v-if="userStore.customer.default_payment_type === 'visa'" class="form-control" type="text" placeholder="Card Number" required="" v-model="userStore.customer.default_payment_reference">
							<div class="invalid-feedback">Please fill in the card number!</div>
						</div>
						<div class="col-sm-6">
							<input v-if="userStore.customer.default_payment_type === 'paypal'" class="form-control" type="text" placeholder="Email" required="" v-model="userStore.customer.default_payment_reference">
							<div class="invalid-feedback">Please provide a valid email!</div>
						</div>
						<div class="col-sm-3">
							<input v-if="userStore.customer.default_payment_type === 'mbway'" class="form-control" type="text" placeholder="Phone Number" required="" v-model="userStore.customer.default_payment_reference">
							<div class="invalid-feedback">Please provide phone number valid!</div>
						</div>
						<div class="col-sm-6">
							<button class="btn btn-primary d-block w-100" type="submit">Update payment information</button>
						</div>
					</div>
				</div>
			</div>
